const weatherLaieURL = 'https://api.openweathermap.org/data/2.5/weather?id=5847387&appid=95bbd03231863ab385f03d018a4aeaaa&units=imperial';

fetch(weatherLaieURL)
    .then(
        response => {
    ...
    .then(
        ...
        //     .setAttribute('src', image);
            ...
            if (currentTemp <= 50 && windSpeed >= 3) {
                ...
                document.getElementById('windChillLaie').innerHTML = windChill.toFixed(0) + ' &deg' + 'F'; //50&deg
            } else {
                windChill = 'N/A';
                document.getElementById('windChillLaie').innerHTML = windChill;
            }

            console.log(windChill);

            document.getElementById('currentlyLaie').innerHTML = currently;
            document.getElementById('currentTempLaie').innerHTML = currentTemp + ' &deg' + 'F';
            document.getElementById('humidityLaie').innerHTML = humidity + '%';
            document.getElementById('windSpeedLaie').innerHTML = windSpeed + ' mph';
